...
public interface CreateOptions extends Options {
	...
	@Description("The type of Liferay module to create. "
            + "Valid values are portlet, jspportlet, service, or servicewrapper. " 
            + "For service or servicewrapper projectTypes, the service argument must be a fully qualified class name.")
