...
import blade.migrate.ide.WorkspaceMigrationImpl;
...
"</WorkspaceMigration>";
	...
	public WorkspaceMigrationImplTest() {
		_sampleProblems.add(new Problem("foo", "bar", "foobar", "test", "LPS-123", new File(TMPDIR), 999, 10, 20));
		_sampleProblems.add(new Problem("foo2", "bar2", "foobar2", "test2", "LPS-1232", new File(TMPDIR), 9992, 102, 202));
	}
