...
@Component(
	property = {
		...
		"problem.url=https://github.com/liferay/liferay-portal/blob/master/readme/7.0/BREAKING_CHANGES.markdown#removed-asset-tag-properties"
	},
...
public class AssetTagProperties  extends JavaFileMigrator {
	...
	protected List<SearchResult> searchJavaFile(File file, JavaFileChecker javaFileChecker) {
		...
		//all imports from AssetTagPropertyLocalServiceUtil and AssetTagPropertyServiceUtil
		SearchResult importsDecla = javaFileChecker.findImport("com.liferay.portlet.asset.service.AssetTagPropertyLocalServiceUtil");
		if( importsDecla != null){
			searchResults.add(importsDecla);
		}
		importsDecla = javaFileChecker.findImport(" com.liferay.portlet.asset.service.AssetTagPropertyServiceUtil");
		if( importsDecla != null){
			searchResults.add(importsDecla);
		}
		...
		if(searchResults.size() > 0 ){
			System.out.println(searchResults.size()+":"+file.getAbsolutePath());
